	...
	componentDidMount() {
		AsyncStorage.getItem("username", (error, result) => {
			...
			AsyncStorage.getItem("token", (error, result2) => {
				fetch("https://penyewaanbatch124.herokuapp.com/api/datasewa/search/" + result+"?token="+result2, {
					method: "GET"
				})
					...
					.then((data) => {
						...
						fetch("https://penyewaanbatch124.herokuapp.com/api/kdbarang/" + KdBarang, {
							...
							.then((data) => {
								...
								fetch("https://penyewaanbatch124.herokuapp.com/api/pembayaran/kddatasewa/" + KdDataSewa + "?token=" + result, {
									method: "GET"
								})
									.then((response) => response.json())
									.then((data) => {
